                    ...
                    @auth
                        <div class="relative" @click.away="userMenu = false">
                            ...
                            <div x-show="userMenu" x-cloak
                                ...
                                {{-- Panel Admin (solo para admin/superadmin) --}}
                                @if(auth()->user()->hasAdminAccess())
                                    <a href="/admin" class="flex items-center px-4 py-2 text-sm text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 font-medium">
                                ...
                                {{-- Gestionar Productos (solo para cocineros) --}}
                                @if(auth()->user()->isCocinero())
                                    <a href="/admin" class="flex items-center px-4 py-2 text-sm text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 font-medium">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
